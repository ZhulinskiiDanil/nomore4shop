export default {
  ...
  notifications: {
    ...
    auth: {
      ...
      emailServerError: {
        // notifications.error.title
        description: 'Ошибка сервера, не удалось отправить письмо на вашу почту'
      },
  ...
  home: {
    ...
    mainSection: {
      ...
      description: 'Создай новый визуальный опыт в играх CS2 и т.д',
      button: {
        name: 'Попробовать'
      }
    },
  ...
  auth: {
    ...
    signUpSubmit: {
      ...
      description: 'Для подтверждения отправьте этот код нашему боту Telegram или ВК',
    ...
    resetPassword: {
      ...
      title: 'Восстановление пароля',
      success: 'Пароль успешно сброшен. Новый пароль выслан вам на почту',
      submit: 'Войти',
      process: 'Отправка...'
    }
  },
  ...
  settings: {
    ...
    email: {
      title: 'Email',
      desription: 'Управление почтой привязанной к аккаунту SOURCECHANGER',
      buttons: {
        change: {
          name: 'Изменить'
        }
    ...
    password: {
      title: 'Пароль',
      desription: 'Управление паролем нужным для захода в аккаунт SOURCECHANGER',
      inputs: {
        oldPassword: {
