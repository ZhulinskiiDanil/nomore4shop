export default {
  ...
  errors: {
    auth: {
      ...
      TO_MANY_REQUESTS: "Ви надсилаєте надто багато запитів, зачекайте трохи",
      ...
      EMAIL_EXISTS: "Користувач із таким e-mail вже зареєстрований",
  ...
  notifications: {
    ...
    auth: {
      ...
      emailServerError: {
        // notifications.error.title
        description: 'Помилка сервера, не вдалося надіслати листа на вашу пошту'
      },
  ...
  home: {
    ...
    mainSection: {
      ...
      description: 'Створи новий візуальний досвід у іграх CS2 i.т.д.',
      button: {
        name: 'Спробувати'
      }
    },
    ...
    features: [
      {
        title: 'Скини',
        description: 'Значимість цих проблем настільки очевидна, що реалізація намічених планових завдань відіграє важливу роль у формуванні системи навчання кадрів, що відповідає насущним потребам'
      },
      {
        title: 'Ефекти',
        description: 'Значимість цих проблем настільки очевидна, що реалізація намічених планових завдань відіграє важливу роль у формуванні системи навчання кадрів, що відповідає насущним потребам'
  ...
  auth: {
    ...
    signUpSubmit: {
      ...
      description: 'Для підтвердження надішліть цей код нашому боту Telegram або ВК',
    ...
    resetPassword: {
      ...
      title: 'Відновлення паролю',
      success: 'Пароль успішно скинутий. Новий пароль надіслано вам на пошту',
      submit: 'Увійти',
      process: 'Надсилання...'
    }
  },
  ...
  settings: {
    ...
    email: {
      title: 'Email',
      desription: 'Управління поштою, прив\'язаною до облікового запису SOURCECHANGER',
      buttons: {
        change: {
          name: 'Змінити'
        }
    ...
    password: {
      title: 'Пароль',
      desription: 'Управління паролем необхідним для входу в обліковий запис SOURCECHANGER',
      inputs: {
        oldPassword: {
